...
insert into emp_data(empid,empname,SAPID) values(52363798,"Balasack",43240932);
insert into emp_data(empid,empname,SAPID) values(52363777,"Vini",432421);
insert into emp_data(empid,empname,SAPID) values(52363799,"9a9a",497282);
